(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/cc-common/cc-slotbase-v2/component/Bezier3D.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'f33ffaM6JBCZqOeDQQQ9Iwy', 'Bezier3D', __filename);
// cc-common/cc-slotbase-v2/component/Bezier3D.js
...
cc.Class({
    ...
    transformPosition2D: function transformPosition2D() {
    ...
    setBezier: function setBezier(v0, v1, v2, v3) {
        this.p0 = v0;
        this.p1 = v1;
        this.p2 = v2;
        this.p3 = v3;
    },
    GetPointAtTime: function GetPointAtTime(timePoint) {
        var p = cc.v3(0, 0, 0);
        if (this.useBezier) {
            var u = 1 - timePoint;
            var tt = timePoint * timePoint;
            var uu = u * u;
            var uuu = uu * u;
            var ttt = tt * timePoint;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=Bezier3D.js.map
